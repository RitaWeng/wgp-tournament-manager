...
> （2026-07-19，共 26 步）。S6 待 P2 實作時補。
...
- **進度（2026-07-19）**：**P1（S7 守衛 A 可見化＋S5 配對對帳）已實作並驗證 ✅**——
  ...
  ＋S5 三步全綠。僅剩 **S6（P2 重設防呆）** 未動工——另注意 Codex review 指出的相鄰問題：
  重設清空 `scoredRounds` 後，若線上賽事仍在，輪詢對帳會把後端已鎖輪次主動解鎖，
  S6 實作時應一併處理（重設時先確認／一併結束線上賽事）。
